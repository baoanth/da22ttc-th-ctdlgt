...
int main()
{
	...
	printf("Enter x1 to estimate the polynomial value 1: ");
	scanf("%f", &x1);
	printf("Polynomial value 1: P(%.2f)= %.2f\n", x1, uocluong(dt1, x1));
    
    printf("Enter x2 to estimate the polynomial value 2: ");
	scanf("%f", &x2);
	printf("Polynomial value 1: P(%.2f)= %.2f", x2, uocluong(dt2, x2));
