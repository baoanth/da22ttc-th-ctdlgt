...
void find_HH_by_ma(char * mahang,HangHoa* hh_array,int n ){
	...
	for(i = 0;i<n;i++){
		...
		if(c == 0) printf("Khong tim thay ma hang\n");	
	}
}

int main(){
    HangHoa h1 = {"A011", "Banh", 5, 500, 2500};
    HangHoa h2 = {"A012", "Keo", 5, 700, 5500};
    HangHoa h3 = {"A013", "Kem", 5, 1000, 5000};
